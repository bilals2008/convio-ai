...
const widgetConfigFields = {
  ...
  headerSubtitleColor: z.string().optional(),
  onlineIndicatorColor: z.string().optional(),
  headerIconColor: z.string().optional(),
  ...
  customWidth: z.number().min(0).max(500).optional(),
