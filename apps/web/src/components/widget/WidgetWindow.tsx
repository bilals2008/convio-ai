...
export function WidgetWindow() {
  const { isOpen, isMinimized, isEmbed, entering, exiting, position, error, dismissError } = useWidgetState()
  ...
  return (
    <div
      className={cn(
        ...
        !exiting && !isEmbed && 'rounded-2xl shadow-[0_12px_48px_rgba(0,0,0,0.15)] ring-1 ring-black/[0.06]'
      )}
