...
export function PromoBanner({ hidden }: { hidden?: boolean }) {
  ...
  return (
    <div className="relative bg-gradient-to-r from-primary/5 via-background to-primary/5 border-b border-primary/10">
      <div className="mx-auto flex max-w-[1320px] flex-col items-center justify-center gap-1 px-5 py-2.5 text-center text-xs sm:flex-row sm:gap-2 sm:text-sm">
